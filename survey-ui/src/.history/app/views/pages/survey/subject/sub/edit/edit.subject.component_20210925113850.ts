...
import { CatogoryEditModel } from 'src/app/core/_models/category.model';
...
export class EditCategoryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.activateRouter.snapshot.queryParams['id']) {
      ...
      this.service.get(this.id).subscribe((reponse: CatogoryEditModel) => {
  ...
  save() {
    ...
    debugger;
    const model: CatogoryEditModel = this._formGroup.value;
